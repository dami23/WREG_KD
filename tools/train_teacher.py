...
def main(args):
    ...
    # head_feats_dir = osp.join('/media/mi/Data/Dataset/feats/', opt['dataset_splitBy'], 'mrcn', feats_dir)
    # loader.prepare_mrcn(head_feats_dir, args)

    # ann_feats = osp.join('/media/mi/Data/Dataset/feats/', opt['dataset_splitBy'], 'mrcn',
